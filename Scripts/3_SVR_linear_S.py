...
OUTPUT_DIR = r"C:\Publications\soil trace elements\3_SVR_S"
...
def setup_logging():
    ...
    file_handler = logging.FileHandler(f"{log_file_loc}\\3_SVR_S_{EXECUTION_ID}.log", "w")
...
def model_predictions(
    ...
    for i in range(0, num_iterations):
        ...
        y_pred_extreme_Sdep = 10 ** estimator.predict(predictors["extreme_Sdep"].to_numpy())
